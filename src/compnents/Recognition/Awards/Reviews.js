    ...
    return(
        <div className='header'>
            ...
            <div className='awardDetails'>
                <div>
                    <p>Abhinav is very positive and self-motivated person who is always willing to push himself out of his comfort zone and better himself. He tries to provide better ideas and suggestions to improve the overall UI of the portal. He is aways available to take up the responsibilities and is very supportive.</p>
                    <p className='reviewer'>--SR(Application Development Associate Manager)</p>
                    ...
                    <p>Abhinav is dedicated teammate who's shown a lot of promises in the project. He is hardworking and curious and is always ready to take up tasks. He is agile and tries to understand the product end to end, analyzes all use cases, and develops from a holistic approach.</p>
