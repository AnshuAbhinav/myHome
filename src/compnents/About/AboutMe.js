    ...
    return (
        <div className='rootDiv'>
            <div className='contentWrapper'>
                ...
                <div className='detail'>Working as <span style={{color: 'orange', fontWeight: 'bold'}}>Appliaction Development Senior Analyst</span> in <span style={{color: 'orange', fontWeight: 'bold'}}>Accenture</span> with some of the most brilliant minds to provide best solution for the clients with cutting edge technology.</div>
